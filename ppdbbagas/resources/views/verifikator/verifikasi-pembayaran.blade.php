    ...
    <div class="main-content">
        <div class="header">
            <div class="welcome-text">
                ...
                <p>Kelola dan verifikasi pembayaran pendaftar PPDB</p>
            </div>
            <div class="user-info">
        ...
        <div class="payment-grid" id="paymentGrid">
            @php
            $payments = [
                ['id' => 1, 'nama' => 'Ahmad Rizki Pratama', 'email' => 'ahmad@siswa.com', 'jurusan' => 'PPLG', 'nominal' => 500000, 'status' => 'pending', 'tanggal' => '2024-01-15 10:30'],
                ['id' => 2, 'nama' => 'Siti Nurhaliza', 'email' => 'siti@siswa.com', 'jurusan' => 'AKUNTANSI', 'nominal' => 500000, 'status' => 'verified', 'tanggal' => '2024-01-14 14:20'],
                ['id' => 3, 'nama' => 'Budi Santoso', 'email' => 'budi@siswa.com', 'jurusan' => 'DKV', 'nominal' => 500000, 'status' => 'pending', 'tanggal' => '2024-01-13 09:15'],
                ['id' => 4, 'nama' => 'Dewi Sartika', 'email' => 'dewi@siswa.com', 'jurusan' => 'ANIMASI', 'nominal' => 500000, 'status' => 'rejected', 'tanggal' => '2024-01-12 16:45']
            ];
            @endphp

            @forelse($payments as $payment)
            <div class="payment-card payment-item" data-name="{{ strtolower($payment['nama']) }}" data-status="{{ $payment['status'] }}" data-jurusan="{{ $payment['jurusan'] }}">
                <div class="d-flex align-items-start mb-3">
                    <div class="student-avatar me-3">
                        {{ substr($payment['nama'], 0, 1) }}
                    </div>
                    <div class="flex-grow-1">
                        <div class="student-name">{{ $payment['nama'] }}</div>
                        <div class="student-email">{{ $payment['email'] }}</div>
                        <div class="major-badge">{{ $payment['jurusan'] }}</div>
                    </div>
                </div>
                ...
                <div class="action-buttons">
                    <button class="btn btn-view" onclick="viewProof({{ $payment['id'] }})">
                        <i class="fas fa-eye me-1"></i> Lihat Bukti
                    </button>
                    @if($payment['status'] == 'pending')
                    <button class="btn btn-verify" onclick="verifyPayment({{ $payment['id'] }})">
            ...
            <div class="empty-state">
                ...
                <h3 class="text-white fw-bold mb-3">Belum Ada Pembayaran</h3>
                <p class="text-white-50">Belum ada pembayaran yang perlu diverifikasi saat ini.</p>
            </div>
            @endforelse
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="rejectReason" rows="4" placeholder="Masukkan alasan penolakan pembayaran..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-reject" onclick="confirmReject()">Tolak Pembayaran</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="https://via.placeholder.com/600x400/ff6b6b/ffffff?text=BUKTI+PEMBAYARAN" class="img-fluid rounded" alt="Bukti Pembayaran">
                </div>
            </div>
        </div>
    </div>
