...
<body>
    ...
    <div class="main-content">
        ...
        <div class="menu-grid">
            ...
            <a href="{{ route('admin.master-spmb') }}" class="menu-card">
                <div class="menu-icon">
                    <i class="fas fa-cogs"></i>
                </div>
                <div class="menu-title">Master Data SPMB</div>
                <div class="menu-desc">Kelola data lengkap sistem PPDB dengan interface modern</div>
            </a>
