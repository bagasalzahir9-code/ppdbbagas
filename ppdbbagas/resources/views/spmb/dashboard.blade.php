            ...
            <div class="col-md-3 mb-3">
                <div class="status-card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold">{{ auth('calon_siswa')->user()->status ?? 'Draft' }}</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="status-card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold">{{ auth('calon_siswa')->user()->status ? 'Terverifikasi' : 'Pending' }}</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="status-card">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold">{{ auth('calon_siswa')->user()->bukti_pembayaran ? 'Uploaded' : 'Belum Bayar' }}</h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
        ...
        <div class="progress-section">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <small class="text-white-50">3 dari 5 tahap selesai</small>
                </div>
