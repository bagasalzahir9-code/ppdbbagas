    ...
    <div class="main-content">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-value">{{ $pendingVerifikasi ?? 15 }}</div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">{{ $terverifikasi ?? 25 }}</div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">{{ ($pendingVerifikasi ?? 15) + ($terverifikasi ?? 25) + 3 }}</div>
